        ...
        <>
            {loading ? (
                ...
                >
                    <p
                        className={
                            occurredError ? styles.error : styles.success
                        }
                    >
                        {message}
                    </p>
                    ...
                    <div className={styles.section_wrapper}>
                        ...
                        <div className={styles.column_wrapper}>
                            ...
                            <div className={styles.checkbox_wrapper}>
                                <input
                                    {...register('services.swimmingPool')}
                                    type="checkbox"
                                />
